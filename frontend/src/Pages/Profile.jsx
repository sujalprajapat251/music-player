...
const Profile = () => {
  ...
  {/* Card */}
  <div className="pro-content bg-[#1F1F1F]/80 backdrop-blur-xl p-6 md:p-10 rounded-md shadow-lg">
    {/* Avatar */}
    <div className="flex flex-col md:flex-row md:items-center gap-6 md:gap-10 mb-8">
      <div className="relative w-[110px] h-[110px] md:w-[130px] md:h-[130px] mx-auto md:mx-0">
        ...
        <label
          ...
          className="absolute bottom-2 right-2 bg-white p-2 rounded-full cursor-pointer shadow-lg hover:scale-105 transition-transform"
        >
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mb-8">
        <div>
          ...
          <input
            ...
            disabled={isSubmitting}
            className="w-full bg-[#2c2c2c] text-white rounded-md px-4 py-2.5 shadow-inner focus:outline-none focus:ring-2 focus:ring-violet-100 transition disabled:opacity-50"
            placeholder="John"
          />
        </div>
        ...
        <div>
          ...
          <div className="flex">
            <select
              ...
              disabled={isSubmitting}
              className="bg-[#2c2c2c] text-white rounded-l-md px-3 py-2.5 focus:outline-none focus:ring-2 focus:ring-violet-100 border-r border-gray-700 disabled:opacity-50"
            >
            ...
            <input
              ...
              onChange={handleChange}
              disabled={isSubmitting}
              className="w-full bg-[#2c2c2c] text-white rounded-r-md px-4 py-2.5 shadow-inner focus:outline-none focus:ring-2 focus:ring-violet-100 disabled:opacity-50"
      ...
      <div className="mb-8">
        ...
        <div className="flex flex-wrap items-center gap-4">
          {["Male", "Female", "Other"].map((g) => (
            <label
              key={g}
              className="flex items-center text-white cursor-pointer px-4 py-2 transition"
            >
              <input
                type="radio"
                name="gender"
                ...
                disabled={isSubmitting}
                className="mr-2 w-4 h-4 accent-violet-400 disabled:opacity-50"
              />
              {g}
            </label>
          ))}
      ...
      <div className="flex justify-center md:justify-start">
        <button
          ...
          className="bg-white text-black font-semibold px-10 py-3 rounded-lg hover:scale-105 transition-transform disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center"
        >
          {isSubmitting ? (
            <>
              <svg
