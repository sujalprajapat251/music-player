                ...
                {forgotPasswordStep === 0 && (
                    <div className="bg-gray-950 bg-opacity-90 rounded-[4px] shadow-lg m-4 md:m-0 p-4 md:p-8 w-full max-w-md min-h-[600px]">
                        ...
                        <div className="relative">
                            ...
                            <button className="flex items-center bg-white text-black px-4 py-2 rounded mr-2">
                                <img src="/Images/google-logo.png" alt="Google" className="w-5 h-5 mr-2" />
                                Google
                            </button>
                            <button className="flex items-center bg-blue-700 text-white px-4 py-2 rounded">
                                ...
                                <GoogleLogin
                                    onSuccess={response => {
                                        ...
                                        dispatch(googleLogin({ uid, firstName, lastName, email })).then((response) => {
                                            console.log(response);
