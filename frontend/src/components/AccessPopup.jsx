...
const AccessPopup = ({ onClose }) => {
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 px-4">
            {/* Popup Box */}
            <div className="bg-[#1E1E1E] rounded-lg shadow-lg p-6 w-full max-w-md">
                {/* Title */}
                ...
                <div className="flex justify-end">
                    <button onClick={() => { onClose && onClose(); }} className="bg-purple-600 hover:bg-purple-700 text-white font-medium py-2 px-10 rounded-full transition text-right">
                        OK
                    </button>
                </div>
            </div>
