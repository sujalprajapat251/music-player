    ...
    {showOffcanvas1 === true && (
      ...
      <div className="fixed z-[10] w-full h-full  transition-transform  left-0 right-0 translate-y-full bottom-[210px] sm:bottom-[260px] md600:bottom-[275px] md:bottom-[450px]  lg:bottom-[455px] xl:bottom-[465px] 2xl:bottom-[516px]" tabIndex="-1" aria-labelledby="drawer-swipe-label">
        <div className="  border-b border-[#FFFFFF1A] h-full">
          ...
          >
            <div className="flex items-center p-2 sm:p-4 min-w-max bg-[#1f1f1f]">
              <div className="flex gap-2 sm:gap-4 min-w-max">
                {activeEffects.map((effect) => (
                  <div key={effect.instanceId} className="w-[150px] h-[180px]  sm:w-[190px] sm:h-[234px] md600:w-[220px] md600:h-[250px] md:w-[230px] md:h-[320px] lg:w-[240px] lg:h-[337px] xl:w-[240px] xl:h-[345px] 2xl:w-[200px] 2xl:h-[300px] bg-[#1a1a1a] rounded-xl overflow-hidden shadow-lg text-white flex flex-col shrink-0">
                ...
                {activeEffects.length < effectsLibrary?.length && (
                  <div className="w-[150px] h-[180px]  sm:w-[190px] sm:h-[234px] md600:w-[220px] md600:h-[250px] md:w-[230px] md:h-[320px] lg:w-[240px] lg:h-[337px] xl:w-[240px] xl:h-[345px] 2xl:w-[200px] 2xl:h-[300px] bg-[#1a1a1a] rounded-xl flex flex-col items-center justify-center text-white cursor-pointer hover:bg-[#2a2a2a] transition-colors shrink-0 border-2 border-dashed border-gray-600"
                ...
                {Array.from({ length: 4 - activeEffects.length - 1 }, (_, index) => (
                  <div key={index} className="w-[150px] h-[180px]  sm:w-[190px] sm:h-[234px] md600:w-[220px] md600:h-[250px] md:w-[230px] md:h-[320px] lg:w-[240px] lg:h-[337px] xl:w-[240px] xl:h-[345px] 2xl:w-[200px] 2xl:h-[300px] bg-[#1a1a1a] rounded-xl shrink-0 border-2 border-dashed border-gray-600"
