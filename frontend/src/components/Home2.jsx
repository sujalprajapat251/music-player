...
import { deleteMusic, getAllMusic, moveToFolderMusic, renameMusic } from '../Redux/Slice/music.slice';
...
const Home2 = () => {
  ...
  const initializeAudioContext = useCallback(async () => {
    ...
    }, [allMusic, playingMusicId, musicProgress]);
            ...
            <div className="p-3 lg:p-5 xl:p-6 2xl:p-8 3xl:p-10 bg-[#141414]">
                ...
                <div className='max-h-[80vh] min-h-[760px] overflow-auto d_customscrollbar'>
                    ...
                    {sortedAndFilteredFolders?.map((ele, index) => (
                        <div
                        key={ele._id}
                        className="flex pt-2  md600:pt-3  lg:pt-3 ps-2 md600:ps-3 2xl:pt-4 2xl:ps-4 3xl:pt-5 3xl:ps-5 pe-2 md600:pe-3 md:pe-2 border-b border-[#FFFFFF1A] pb-2 cursor-pointer"
                        onClick={() => navigate(`/project/folder/${ele._id}`)}
                    >
                    ...
                    {allMusic.filter(ele => !ele.isDeleted).filter(ele => {
                        ...
                        console.log("Audio URL for", ele.name, ":", audioUrl);
