...
const Effects = ({ showOffcanvas, setShowOffcanvas }) => {
    ...
    <div>
        ...
        {showOffcanvas && (
        <>
         <div className="absolute top-0 z-[999] bg-primary-light dark:bg-primary-dark right-0 h-[calc(100vh-82px)] sm:h-[calc(100vh-66px)] md:h-[calc(100vh-96px)] shadow-lg transition-transform duration-300 ease-in-in transform translate-x-0 overflow-auto w-full sm:w-[100%] md600:w-[51%] lg:w-[38%] xl:w-[28%] 2xl:w-[25%] 3xl:w-[23%]">
            <div className=" text-secondary-light dark:text-secondary-dark bg-primary-light dark:bg-primary-dark">
                <div className=' border-l border-[1px] border-[#1414141A] dark:border-[#FFFFFF1A] bg-transparent'>
                    <div className='px-[6px] xs:px-[12px] sm:px-[14px] md600:px-[14px] lg:px-[14px] xl:px-[12px] 3xl:px-[16px]'>
                        <div className=' py-[10px] xs:py-[10px] sm:py-[10px] md600:py-[12px] lg:py-[16px] 3xl:py-[16px] border-b border-[#1414141A] dark:border-[#FFFFFF1A] flex items-center justify-between'>
                            <h5 className='text-secondary-light dark:text-secondary-dark text-[14px] xs:text-[16px] sm:text-[16px] md600:text-[18px] lg:text-[20px] font-[600]'>Effects</h5>
                            <button
                                className=" text-[18px] xs:text-[20px] sm:text-[22px] md600:text-[22px] lg:text-[24px] 3xl:text-[24px] text-secondary-light dark:text-secondary-dark hover:text-gray-200 dark:hover:text-gray-300 transition-colors duration-200"
                        ...
                        <div className="w-full max-w-md600 mx-auto py-[10px] xs:py-[12px] sm:py-[12px] md600:py-[12px] lg:py-[16px] 3xl:py-[20px] ">
                            <div className="relative mb-1 xs:mb-4 sm:mb-4 md600:mb-4 lg:mb-4 xl:mb-4 3xl:mb-4">
                                <div className="relative flex items-center">
                                    <IoSearch className="absolute left-2 xs:left-3 xs:w-4 xs:h-4 sm:left-3 sm:w-4 sm:h-4 md600:w-4 md600:h-4 lg:h-5 lg:w-5 text-[#888888] dark:text-[#FFFFFF99]" />
                                    <input type="text" placeholder="Search effects..." className="w-full bg-primary-light dark:bg-primary-dark border border-[#000] dark:border-[#fff] text-[10px] xs:text-[12px] sm:text-[14px] md600:text-[14px] lg:text-[14px] text-secondary-light dark:text-secondary-dark placeholder-gray-400 rounded pl-6 pr-3 xs:pl-8 xs:pr-3 xs:py-2 sm:pl-8 sm:pr-3 sm:py-2 md600:pl-8 md600:pr-3 md:py-2 lg:pl-10 lg:pr-4 lg:py-2 outline-none focus:outline-none transition-all duration-200" value={searchTerm} onChange={handleSearchChange}/>
                                </div>
                            </div>
                            <div className='flex flex-wrap gap-1 xs:gap-2 sm:gap-2 md600:gap-2 3xl:gap-2'>
                                {/* All category */}
                                <div
                                    className={`bg-[#E5E5E5] dark:bg-[#262529] w-[67px] xs:w-[84px] sm:w-[84px] md600:w-[78px] md:w-[82px] lg:w-[82px] xl:w-[83px] 2xl:w-[84px] 3xl:w-[76px] rounded-[2px] text-secondary-light dark:text-secondary-dark text-[10px] xs:text-[12px] sm:text-[12px] lg:text-[12px] xs:py-[4px] sm:py-[4px] lg:py-[4px] xl:py-[5px] text-center cursor-pointer hover:bg-[#b8b8b8] dark:hover:bg-gray-600 transition-colors duration-200`}
                                ...
                                {effectCategories.map((cat, index) => {
                                    ...
                                    return (
                                        <div key={index} className={`bg-[#E5E5E5] dark:bg-[#262529] w-[67px] xs:w-[84px] sm:w-[85px] md600:w-[78px] md:w-[82px] lg:w-[82px] xl:w-[83px] 2xl:w-[84px] 3xl:w-[84px] rounded-[2px] text-secondary-light dark:text-secondary-dark text-[10px] xs:text-[12px] sm:text-[12px] lg:text-[12px] xs:py-[4px] sm:py-[4px] lg:py-[4px] xl:py-[5px] text-center cursor-pointer hover:bg-[#b8b8b8] dark:hover:bg-gray-600 transition-colors duration-200 ${isSelected ? 'border-2 border-blue-500 bg-blue-100 dark:bg-blue-900' : ''}`} onClick={() => handleCategoryClick(cat)}>{cat}</div>
                                    )
                                })}
                            </div>
                            {(selectedCategory || searchTerm) && (
                                <div className="mt-3 flex items-center justify-between">
                                    <p className="text-[10px] xs:text-[12px] sm:text-[12px] md600:text-[12px] text-gray-600 dark:text-gray-400">
                                        {selectedCategory && `Category: ${selectedCategory}`}
                                        {selectedCategory && searchTerm && " | "}
                                        {searchTerm && `Search: "${searchTerm}"`}
                                        {` (${filteredEffects.length} effects)`}
                                    </p>
                                    <button onClick={clearFilters} className="text-[10px] xs:text-[12px] sm:text-[12px] md600:text-[12px] text-blue-500 hover:text-blue-700 underline">Clear</button>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="bg-[#1F1F1F] w-full py-2 xs:py-3 sm:py-3 md600:py-3 md:my-4 lg:py-5 lg:my-3 3xl:py-7 hidden">
                            <p className="text-white text-[8px] xs:text-[10px] sm:text-[10px] md600:text-[12px] md:text-[14px] lg:text-[16px] text-center">Add a track to apply effects</p>
                            <div className="flex gap-1 xs:gap-2 sm:gap-2 md:gap-2 lg:gap-3 bg-white rounded-md w-[50%] sm:w-[45%]  md600:w-[74%] md:w-[65%] lg:w-[60%] xl:w-[55%] 3xl:w-[53%] 4xl:w-[45%] mx-auto justify-center items-center px-1 py-1 mt-2 md600:px-2 md600:py-2 md600:mt-3 lg:px-3 lg:py-2 xl:px-4 xl:mt-3 3xl:px-5 3xl:py-3 3xl:mt-4">
                        ...
                        <div className="mt-2 xs:mt-3 sm:mt-3 md600:mt-4 md:mt-3 lg:mt-4 3xl:mt-5">
