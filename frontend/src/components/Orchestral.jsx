...
const Pianodemo = ({ onClose }) => {
  ...
  return (
    <>
      {showOffcanvas1 === true && (
        <>
          <div className="fixed z-[10] w-full h-full transition-transform left-0 right-0 translate-y-full bottom-[333px] sm:bottom-[350px] md:bottom-[403px] lg:bottom-[437px] xl:bottom-[441px] 2xl:bottom-[467px]" tabIndex="-1" aria-labelledby="drawer-swipe-label">
