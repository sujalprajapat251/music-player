...
const INSTRUMENTS = [
    ...
    { id: 'contrabass', name: 'Contrabass (Double Bass)', category: 'Strings' },
    ...
    { id: 'tremolo_strings', name: 'Tremolo Strings', category: 'Strings' },
...
const Pianodemo = ({ onClose }) => {
  ...
  return (
    <>
      {openInstrumentModal && (
          <OpenInstrumentModal onClose={() => setOpenInstrumentModal(false)} initialCategory={"Orchestral"} initialSubCategory={"Solo orchestral"} />
      )}
      {showOffcanvas1 === true && (
        <>
          <div className="fixed z-[10] w-full h-full transition-transform left-0 right-0 translate-y-full bottom-[333px] sm:bottom-[350px] md:bottom-[403px] lg:bottom-[437px] xl:bottom-[441px] 2xl:bottom-[467px] shadow-[0_-2px_11px_rgba(0,0,0,0.08)]" tabIndex="-1" aria-labelledby="drawer-swipe-label">
                ...
                {activeTab === 'Instruments' && (
                  <>
                    <div className="bg-white dark:bg-[#1F1F1F] flex items-center justify-center py-2 px-2 md600:px-2 md600:pt-2 md600:pb-1 gap-4 sm:gap-6 md600:gap-12 md:gap-16 lg:pt-4 lg:pb-2 lg:px-3 lg:gap-20 2xl:pt-5 2xl:pb-3 2xl:px-3 2xl:gap-24">
                      <div className="bg-gray-200 dark:bg-[#353535] p-2 lg:p-2 rounded-lg cursor-pointer">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1 md600:gap-2 sm:px-1 md600:px-2 md:gap-3 w-[100px] sm:w-[150px] md600:w-[170px] md:w-[172px] lg:gap-4 lg:px-3 lg:w-[230px] 2xl:gap-5 flex-1 justify-start 2xl:px-4 2xl:w-[250px]" 
                          onClick={() => {
                    ...
                    <div className="w-full h-[400px]">
                        <div className="bg-primary-light dark:bg-[#1F1F1F] flex gap-1 md600:gap-2 md:gap-3 pb-2 lg:gap-4 lg:pb-2 2xl:gap-5 items-center justify-between 2xl:pb-3">
                          ...
                          <div className="flex items-center justify-between ">
                            ...
                            <div className="px-1 md600:px-2 lg:px-3 2xl:px-4 w-[50px] md600:w-[60px] lg:w-[80px] 2xl:w-[100px]">
                              <div className="text-secondary-light dark:text-secondary-dark text-center fw-bolder text-[10px] md600:text-[10px] md:text-[12px] lg:text-[14px] 2xl:text-[16px]">Octaves</div>
                            </div>
                        ...
                        <div onClick={() => setPricingModalOpen(true)} className="border rounded-lg border-secondary-light/10 dark:border-secondary-dark/10 ms-auto me-1 md600:me-2 lg:me-3 cursor-pointer">
                          <p className="text-secondary-light dark:text-secondary-dark text-[10px] md600:text-[10px] md:text-[12px] lg:text-[14px] px-2 md600:px-3 md:px-4 lg:px-5 2xl:px-6 py-1">Save Preset</p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-1 md600:gap-2 lg:gap-3 bg-primary-light dark:bg-primary-dark">
                        {autoChords === true &&
                          <div className="w-[30%] sm:w-[40%] md600:w-[25%] md:w-[30%] lg:w-[20%] xl:w-[18%] bg-primary-light dark:bg-primary-dark md600:ms-2 md600:mt-2 lg:ms-3 lg:mt-3 mb-1">
                            <div className="w-full bg-primary-light dark:bg-[#1F1F1F] p-1 md600:p-2 lg:p-3">
                              ...
                              <p className="text-secondary-light/60 dark:text-secondary-dark/60 text-[8px] md:text-[10px] lg:text-[12px] 2xl:text-[14x] truncate mb-2">Play full chords with a single key</p>
                              {/* <div className="flex gap-1 items-center">
                                  <img src={subscription} alt="subscription" className="w-4 h-4" />
                        ...
                        <div ref={pianoSectionsRef} className="w-full h-[149px] sm:h-[170px] md:h-[187px] lg:h-[191px] overflow-x-hidden overscroll-none">
                            ...
                            {Object.keys(getCurrentChordNotes()).map((name, index) => {
                              ...
                              return (
                                <div
                                  ...
                                  className={`cursor-pointer text-secondary-light dark:text-secondary-dark w-[90px] md600:w-[110px] p-1 md600:px-2 md600:py-2 md:w-[120px] lg:w-[110px] rounded-md border ${
                                    activeChords === index
                                ...
                                >
                                  ...
                                  <div className="flex justify-between items-center">
                                    <img src={keyImage[index]?.image} alt="" className="w-2 h-2 md:w-3 md:h-3 lg:w-3 lg:h-3" />
