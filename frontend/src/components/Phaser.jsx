    ...
    return (
        <div className='bg-[#141414]'>
            ...
            <div className={`w-[150px] h-[185px] sm:w-[190px] sm:h-[202px] md:w-[230px] md:h-[250px] lg:w-[240px] lg:h-[255px] xl:w-[240px] xl:h-[285px] 2xl:w-[256px] 2xl:h-[300px] bg-[#302f2f] relative ${!isPoweredOn ? 'opacity-50 pointer-events-none' : ''}`}>
                {/* Tone Knob - Top Right */}
                <div className="absolute top-[20px] left-[20px] sm:top-[25px] sm:left-[30px] md600:top-[25px] md600:left-[40px] lg:top-[55px] lg:left-[40px] xl:top-[45px] xl:left-[50px]">
                    <Knob1 label="Rate"
                        min={-135}
                        max={135}
                ...
                <div className="absolute top-[35px] right-[35px] sm:top-[50px] sm:right-[60px] md600:top-[55px] md600:right-[50px] lg:top-[90px] lg:right-[55px] xl:top-[80px] xl:right-[45px]">
                    <Knob1 label="Depth"
                        min={-135}
                        max={135}
                ...
                <div className="absolute bottom-[5px] right-[25px] sm:bottom-[10px] sm:right-[45px] md600:bottom-[20px] md600:right-[40px] md:bottom-[30px]  lg:bottom-[25px] lg:right-[50px] xl:bottom-[40px] xl:right-[40px]">
                    <Knob2 label="Mix"
                        min={-135}
                        max={135}
