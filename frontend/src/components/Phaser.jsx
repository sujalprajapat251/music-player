...
const Phaser = () => {
    ...
    const currentEffect = activeEffects.find(effect => effect.name === "Phaser");
    ...
    return (
        <div className='bg-[#141414]'>
            <div className={`flex justify-between items-center w-[150px] h-[50px] sm:w-[190px] sm:h-[50px] md600:w-[220px] md:w-[230px] md:h-[55px] lg:w-[240px] xl:h-[60px] 2xl:w-[256px] 2xl:h-[64px] rounded-t-lg px-2 md:px-3 lg:px-8 xl:px-3 transition-colors duration-300 ${isPoweredOn ? 'bg-[#409C9F]' : 'bg-gray-600'
                ...
                />
                <p className='text-white text-[12px] md600:text-[16px]'>Phaser</p>
                <IoClose
            ...
            <div className={`w-[150px] h-[185px] sm:w-[190px] sm:h-[202px] md:w-[230px] md:h-[250px] lg:w-[240px] lg:h-[255px] xl:w-[240px] xl:h-[285px] 2xl:w-[256px] 2xl:h-[300px] bg-[#302f2f] relative ${!isPoweredOn ? 'opacity-50 pointer-events-none' : ''}`}>
                {/* Tone Knob - Top Right */}
