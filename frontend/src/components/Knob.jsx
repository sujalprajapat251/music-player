...
const RevKnob = () => {
  return (
    <>
      <Knob label="Bite" min={-135} max={135} defaultAngle={-90} />
      <Knob label="Attack" min={-135} max={135} defaultAngle={0} />
      <Knob label="Release" min={-135} max={135} defaultAngle={90} />
    </>
  );    
};

export default RevKnob;
