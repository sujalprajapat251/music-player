                ...
                tabs={[
                  {
                    ...
                    content: (
                      <div className="flex flex-col items-center w-1/2">
                        <div className="bg-[#322d3c] rounded-t-lg w-full flex flex-col items-center justify-center py-14 cursor-pointer" onClick={() => setOpen(false)}>
                          <img src={newProjectIcon} alt="Music Note" className="w-12 h-12 mb-2" />
                        </div>
                        <button className="w-full bg-[#9b7ae7] text-white py-4 rounded-b-lg font-medium text-lg transition-colors" onClick={() => setOpen(false)}>Music</button>
                      </div>
                    ),
                  },
                  {
