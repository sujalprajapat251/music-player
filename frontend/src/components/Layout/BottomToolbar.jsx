...
const handleMoveBackwardSmall = () => {
    ...
    return (
        <>
            <div className="fixed bottom-0 w-full flex justify-center md600:justify-between bg-primary-light dark:bg-primary-dark border-t border-[#1414141A] dark:border-[#FFFFFF1A] px-2 py-2 sm:px-3 sm:py-1 md:px-5 md:py-2 xl:px-7 absolute z-[100]">
