...
const Chorus = () => {
    ...
    const currentEffect = activeEffects.find(effect => effect.name === "Chorus");
    ...
    return (
        <div className='bg-[#141414]'>
            ...
            <div className={`w-[150px] h-[185px] sm:w-[190px] sm:h-[213px] md600:w-[220px] md600:h-[210px] md:w-[230px] md:h-[265px] lg:w-[240px] lg:h-[282px] xl:w-[240px] xl:h-[285px] 2xl:w-[256px] 2xl:h-[300px] bg-[#302f2f] relative ${!isPoweredOn ? 'opacity-50 pointer-events-none' : ''}`}>
                {/* Tone Knob - Top Right */}
